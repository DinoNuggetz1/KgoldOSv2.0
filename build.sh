...
case "$response" in
    [yY]*)
        ...
        gcc -m32 -ffreestanding -c sys/acpi.c -o acpi.o
        gcc -m32 -ffreestanding -c sys/stdlib.c -o stdlib.o
        gcc -m32 -ffreestanding -c kernel.c -o kernel.o
        ld -m elf_i386 -T linker.ld boot.o kernel.o stdio.o features.o acpi.o stdlib.o -o kernel.bin
